...
- for extensions to `bpy.utils.user_resource("EXTENSIONS", path="user_default")`
  - VS code uses `vscode_development` local repository, to install extension, see [`blender.addon.extensionsRepository`](vscode://settings/blender.addon.extensionsRepository) 
